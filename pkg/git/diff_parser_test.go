...
// TestGeneratePatchFromDiff is a function.
func TestGeneratePatchFromDiff(t *testing.T) {
...
`,
	...
	for _, s := range scenarios {
		t.Run(s.testName, func(t *testing.T) {
			result := GeneratePatchFromDiff(nil, s.filename, s.diffText, s.firstLineIndex, s.lastLineIndex, s.reverse)
